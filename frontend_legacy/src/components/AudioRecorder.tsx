...
const AudioRecorder: React.FC = () => {
    ...
    const onStartTest = () => {
        setResults({})
        streamer.current.startTestStream()
    };
        ...
        <div className="min-h-screen bg-background p-6">
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <Tabs defaultValue="recording">
                    <TabsList>
                        <TabsTrigger value="recording">Presentation</TabsTrigger>
                        <TabsTrigger value="score" disabled={!results.score}>Speech Score</TabsTrigger>
                        <TabsTrigger value="sim" disabled={!results.transcript}>Speech Similarity</TabsTrigger>
                    </TabsList>
                            ...
                            <Card className="bg-card/50 border-border/50 backdrop-blur-sm hover:border-chart-2/50 transition-all duration-300">
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Button
                                            onClick={() => !isRecording && onStartTest()}
